...
public interface BcRecordService extends IBaseService<BcRecord,Long>{
     ...
     * @return
     */
    ActionResult bcRecordMealSave(String appId,Long id,int status,Integer orderMeal, Integer bcType, Integer bcRs, Long deptId)throws Exception;
     ...
     * @throws Exception
     */
    List<Map<String, Object>> getBcRecordListByDinTime(String appId, String date,Long deptId, String openId,int currentPage,int pageSize) throws  Exception;
